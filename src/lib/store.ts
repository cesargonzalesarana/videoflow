...
interface AppState {
  ...
  setFacebookConnected: (connected: boolean, userName?: string) => void
...
export const useAppStore = create<AppState>((set) => ({
  ...
  facebookUserName: '',
  instagramUserName: '',
  setFacebookConnected: (connected, userName) => set({
    facebookConnected: connected,
    ...(userName !== undefined ? { facebookUserName: userName } : {}),
  }),
  setInstagramConnected: (connected, userName) => set({
