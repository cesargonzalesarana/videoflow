...
export function PropertiesPanel() {
  ...
  if (!clip) {
    return (
      <div className="w-full h-full flex flex-col bg-[#0a0a1f] border-l border-white/5">
      ...
      <ScrollArea className="flex-1">
        <div className="p-3 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => update({ startTime: Math.max(0, parseFloat(e.target.value) || 0) })}
              ...
              <div>
                <Label className="text-[9px] text-white/30">Duración (s)</Label>
                <Input
                  type="number"
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <Label className="text-[9px] text-white/30">Trim Inicio</Label>
                <Input
                  type="number"
                  value={clip.trimStart.toFixed(1)}
                  onChange={(e) => update({ trimStart: Math.max(0, parseFloat(e.target.value) || 0) })}
                  className="h-7 text-xs bg-white/5 border-white/10 text-white"
                  step={0.1}
                  min={0}
                />
              ...
              <div>
                <Label className="text-[9px] text-white/30">Trim Fin</Label>
                <Input
                  type="number"
                  value={clip.trimEnd.toFixed(1)}
                  onChange={(e) => update({ trimEnd: Math.max(0, parseFloat(e.target.value) || 0) })}
                  className="h-7 text-xs bg-white/5 border-white/10 text-white"
                  step={0.1}
                  min={0}
                />
            ...
            <>
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  className="min-h-[60px] text-xs bg-white/5 border-white/10 text-white"
                  rows={3}
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-1.5">
                  <Label className="text-[9px] text-white/30">Tamaño</Label>
                  <Input
                    type="number"
                ...
                <div className="space-y-1.5">
                  <Label className="text-[9px] text-white/30">Peso</Label>
                  <Select
                    value={clip.fontWeight || 'bold'}
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="h-7 w-full bg-white/5 border-white/10 cursor-pointer p-1"
                  />
                </div>
                <div className="space-y-1.5">
                  <Label className="text-[9px] text-white/30">Alineación</Label>
                  <Select
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] text-white/50 uppercase tracking-wider">Posición</Label>
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <Label className="text-[9px] text-white/30">X (%)</Label>
                    <Slider
                      value={[clip.positionX]}
                      onValueChange={(v) => update({ positionX: v[0] })}
                      max={100}
                      min={0}
                      step={1}
                    />
                  ...
                  <div>
                    ...
                    <Slider
                      ...
                      onValueChange={(v) => update({ positionY: v[0] })}
                      max={100}
                      min={0}
                      step={1}
                    />
          ...
          {/* Effects */}
          <div className="space-y-1.5">
            <Label className="text-[10px] text-white/50 uppercase tracking-wider">Transición</Label>
            <Select
          ...
          <div className="pt-2 border-t border-white/5">
            <Button
              ...
              onClick={() => {
                ...
                toast.success('Propiedades reiniciadas')
              }}
            >
